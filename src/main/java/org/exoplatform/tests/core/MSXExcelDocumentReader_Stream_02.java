 ...
 * - cells with error
 */
public class MSXExcelDocumentReader_Stream_02 extends BaseDocumentReader {

  private static final Log LOG = ExoLogger.getLogger("exo.core.component.document.MSXExcelDocumentReader_Stream_02");
  ...
  public void processSheet(
      XSSFOptimizedSheetXMLHandler_02.SheetContentsHandler sheetContentsExtractor,
      StylesTable styles,
...
//    }
    ...
    try {
      ...
      ContentHandler handler = new XSSFOptimizedSheetXMLHandler_02(
  ...
  protected class SheetTextExtractor implements XSSFOptimizedSheetXMLHandler_02.SheetContentsHandler {
