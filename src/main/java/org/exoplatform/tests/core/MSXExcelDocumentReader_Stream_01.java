 ...
 * <p/>
 * we index everything but with a event approach (Sax based)
 */
public class MSXExcelDocumentReader_Stream_01 extends BaseDocumentReader {

  private static final Log LOG = ExoLogger.getLogger("exo.core.component.document.MSExcelDocumentReader_Stream_01");
